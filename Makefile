...
#	echo "Class-Path: java-cup-11b-runtime.jar" > ${DST_DIR}/manifest.mf
	echo "Main-Class: latte.Compiler" > ${DST_DIR}/manifest.mf
	cd ${DST_DIR} && jar xvf ${JAVA_CUP} java_cup && jar cfm compiler.jar manifest.mf latte/*.class latte/*/*.class java_cup && cd ..
