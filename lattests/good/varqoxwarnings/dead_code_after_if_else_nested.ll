...
define i32 @test_if_else_nested() { 
entry: 
 ; conditional elsebr label %block1

block1: 
%tmp6 = call i32 @readInt()
br label %block2

block2: 
%tmp10 = getelementptr [12 x i8], [12 x i8]* @.str.str0, i32 0, i32 0
call void @printString(i8* %tmp10)
br label %block3
