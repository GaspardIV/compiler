...
define void @test_simple_void_return() { 
entry: 
br label %block1

block1: 
ret voidbr label %block2

block2: 
%tmp8 = call i32 @readInt()
br label %block3

block3: 
%tmp11 = getelementptr [12 x i8], [12 x i8]* @.str.str0, i32 0, i32 0
call void @printString(i8* %tmp11)
