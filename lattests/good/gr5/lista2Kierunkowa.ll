...
wrocNaPoczatekIWypisuj_entry:
	...
	%tmp..1 = getelementptr [27 x i8], [27 x i8]* @.str.str0, i32 0, i32 0
...
wrocNaPoczatekIWypisuj.2_while.body:
	...
	%tmp..10 = getelementptr %Lista, %Lista* %a, i32 0, i32 0
...
listaTest_entry:
	...
	%tmp..6 = getelementptr %Lista, %Lista* %tmp..3, i32 0, i32 2
...
listaTest.1_if.true:
	%tmp..13 = getelementptr %Lista, %Lista* %tmp..3, i32 0, i32 1
	...
	%tmp..19 = getelementptr %Lista, %Lista* %tmp..18, i32 0, i32 2
...
zwrocListeDlugosci.2_while.body:
	%tmp..12 = getelementptr %Lista, %Lista* %tmp..3, i32 0, i32 0
	store %Lista* %tmp..5, %Lista** %tmp..12
	%tmp..14 = getelementptr %Lista, %Lista* %a, i32 0, i32 1
	...
	%tmp..20 = getelementptr %Lista, %Lista* %tmp..19, i32 0, i32 2
	store i32 %wsk, i32* %tmp..20
	%tmp..21 = getelementptr %Lista, %Lista* %tmp..19, i32 0, i32 0
	store %Lista* %a, %Lista** %tmp..21
	%tmp..23 = add i32 %wsk, 1
	br label %zwrocListeDlugosci.1_while.cond
zwrocListeDlugosci.3_while.end:
	%tmp..24 = getelementptr %Lista, %Lista* %a, i32 0, i32 1
...
przejdzSieNaKoniecIWypisuj_entry:
	%tmp. = getelementptr [25 x i8], [25 x i8]* @.str.str6, i32 0, i32 0
	call void @printString(i8* %tmp.)
