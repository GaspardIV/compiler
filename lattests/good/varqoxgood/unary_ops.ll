...
check_runtime_entry:
	%tmp..2 = call i1 @btrue()
	br i1 %tmp..2, label %check_runtime.3_if.end, label %check_runtime.1_if.true
check_runtime.1_if.true:
	call void @error()
	ret void
check_runtime.3_if.end:
	%tmp..7 = call i1 @bfalse()
	br i1 %tmp..7, label %check_runtime.4_if.true, label %check_runtime.6_if.end
...
check_runtime.6_if.end:
	...
	br i1 %tmp..18, label %check_runtime.7_if.true, label %check_runtime.9_if.end
...
check_runtime.9_if.end:
	...
	br i1 %tmp..31, label %check_runtime.10_if.true, label %check_runtime.12_if.end
