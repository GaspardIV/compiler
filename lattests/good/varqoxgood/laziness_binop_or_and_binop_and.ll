...
test_and_entry:
	...
	br i1 %tmp..9, label %test_and.4_and, label %test_and.3_expr.end
test_and.4_and:
...
test_and.3_expr.end:
	...
	br i1 %tmp..24, label %test_and.8_and, label %test_and.7_expr.end
test_and.8_and:
...
test_and.7_expr.end:
	...
	br i1 %tmp..39, label %test_and.12_and, label %test_and.11_expr.end
test_and.12_and:
...
test_and.11_expr.end:
	...
	br i1 %tmp..54, label %test_and.16_and, label %test_and.15_expr.end
test_and.16_and:
...
test_and.15_expr.end:
	...
	br i1 %tmp..70, label %test_and.17_if.true, label %test_and.19_if.end
test_and.17_if.true:
	call void @error()
	ret void
test_and.19_if.end:
...
test_or_entry:
	...
	%tmp..7 = load i1 (%X*, i32)*, i1 (%X*, i32)** %tmp..6
	%tmp..9 = call i1 %tmp..7(%X* %tmp..1, i32 1)
	br i1 %tmp..9, label %test_or.3_expr.end, label %test_or.4_or
test_or.4_or:
	%tmp..11 = load void (...)**, void (...)*** %tmp..3
	%tmp..12 = getelementptr void (...)*, void (...)** %tmp..11, i32 0
	%tmp..13 = bitcast void (...)** %tmp..12 to i1 (%X*, i32)**
...
test_or.3_expr.end:
	...
	%tmp..22 = load i1 (%X*, i32)*, i1 (%X*, i32)** %tmp..21
	%tmp..24 = call i1 %tmp..22(%X* %tmp..1, i32 4)
	br i1 %tmp..24, label %test_or.7_expr.end, label %test_or.8_or
test_or.8_or:
	%tmp..26 = load void (...)**, void (...)*** %tmp..3
	%tmp..27 = getelementptr void (...)*, void (...)** %tmp..26, i32 1
	%tmp..28 = bitcast void (...)** %tmp..27 to i1 (%X*, i32)**
...
test_or.7_expr.end:
	...
	%tmp..37 = load i1 (%X*, i32)*, i1 (%X*, i32)** %tmp..36
	%tmp..39 = call i1 %tmp..37(%X* %tmp..1, i32 16)
	br i1 %tmp..39, label %test_or.11_expr.end, label %test_or.12_or
test_or.12_or:
	%tmp..41 = load void (...)**, void (...)*** %tmp..3
	%tmp..42 = getelementptr void (...)*, void (...)** %tmp..41, i32 0
	%tmp..43 = bitcast void (...)** %tmp..42 to i1 (%X*, i32)**
...
test_or.11_expr.end:
	...
	%tmp..52 = load i1 (%X*, i32)*, i1 (%X*, i32)** %tmp..51
	%tmp..54 = call i1 %tmp..52(%X* %tmp..1, i32 64)
	br i1 %tmp..54, label %test_or.15_expr.end, label %test_or.16_or
test_or.16_or:
	%tmp..56 = load void (...)**, void (...)*** %tmp..3
	%tmp..57 = getelementptr void (...)*, void (...)** %tmp..56, i32 1
	%tmp..58 = bitcast void (...)** %tmp..57 to i1 (%X*, i32)**
...
test_or.15_expr.end:
	...
	br i1 %tmp..70, label %test_or.17_if.true, label %test_or.19_if.end
test_or.17_if.true:
	call void @error()
	ret void
test_or.19_if.end:
