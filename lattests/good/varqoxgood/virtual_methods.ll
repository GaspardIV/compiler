@.str.str10 = private unnamed_addr constant [7 x i8] c"B as A\00", align 1@.str.str11 = private unnamed_addr constant [7 x i8] c"B as B\00", align 1@.str.str7 = private unnamed_addr constant [6 x i8] c"C::m8\00", align 1@.str.str6 = private unnamed_addr constant [6 x i8] c"C::m7\00", align 1@.str.str5 = private unnamed_addr constant [6 x i8] c"C::m6\00", align 1@.str.str2 = private unnamed_addr constant [6 x i8] c"A::m3\00", align 1@.str.str18 = private unnamed_addr constant [7 x i8] c"D as D\00", align 1@.str.str1 = private unnamed_addr constant [6 x i8] c"A::m2\00", align 1@.str.str8 = private unnamed_addr constant [6 x i8] c"D::m9\00", align 1@.str.str9 = private unnamed_addr constant [7 x i8] c"A as A\00", align 1@.str.str0 = private unnamed_addr constant [6 x i8] c"A::m1\00", align 1@.str.str16 = private unnamed_addr constant [7 x i8] c"D as B\00", align 1@.str.str17 = private unnamed_addr constant [7 x i8] c"D as C\00", align 1@.str.str3 = private unnamed_addr constant [6 x i8] c"B::m4\00", align 1@.str.str13 = private unnamed_addr constant [7 x i8] c"C as B\00", align 1@.str.str12 = private unnamed_addr constant [7 x i8] c"C as A\00", align 1@.str.str15 = private unnamed_addr constant [7 x i8] c"D as A\00", align 1@.str.str4 = private unnamed_addr constant [6 x i8] c"B::m5\00", align 1@.str.str14 = private unnamed_addr constant [7 x i8] c"C as C\00", align 1 ; --- Class A ---
%A = type { 
}
...
main_entry:
	...
	%tmp..3 = getelementptr [7 x i8], [7 x i8]* @.str.str9, i32 0, i32 0
	...
	%tmp..9 = getelementptr [7 x i8], [7 x i8]* @.str.str10, i32 0, i32 0
	call void @printString(i8* %tmp..9)
	call void @printA(%B* %tmp..7)
	%tmp..12 = getelementptr [7 x i8], [7 x i8]* @.str.str11, i32 0, i32 0
	...
	%tmp..18 = getelementptr [7 x i8], [7 x i8]* @.str.str12, i32 0, i32 0
	call void @printString(i8* %tmp..18)
	call void @printA(%C* %tmp..16)
	%tmp..21 = getelementptr [7 x i8], [7 x i8]* @.str.str13, i32 0, i32 0
	call void @printString(i8* %tmp..21)
	call void @printB(%C* %tmp..16)
	%tmp..24 = getelementptr [7 x i8], [7 x i8]* @.str.str14, i32 0, i32 0
	...
	%tmp..30 = getelementptr [7 x i8], [7 x i8]* @.str.str15, i32 0, i32 0
	call void @printString(i8* %tmp..30)
	call void @printA(%D* %tmp..28)
	%tmp..33 = getelementptr [7 x i8], [7 x i8]* @.str.str16, i32 0, i32 0
	call void @printString(i8* %tmp..33)
	call void @printB(%D* %tmp..28)
	%tmp..36 = getelementptr [7 x i8], [7 x i8]* @.str.str17, i32 0, i32 0
	call void @printString(i8* %tmp..36)
	call void @printC(%D* %tmp..28)
	%tmp..39 = getelementptr [7 x i8], [7 x i8]* @.str.str18, i32 0, i32 0
