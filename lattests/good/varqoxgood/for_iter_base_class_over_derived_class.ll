...
main.4_if.true:
	...
	br i1 %tmp..45, label %main.7_if.true, label %main.8_if.false
main.7_if.true:
	call void @error()
	ret i32 0
main.8_if.false:
...
main.5_if.false:
	...
	br i1 %tmp..55, label %main.10_if.true, label %main.11_if.false
main.10_if.true:
	call void @error()
	ret i32 0
main.11_if.false:
...
main.14_for.body:
	...
	br i1 %tmp..94, label %main.16_if.true, label %main.17_if.false
main.16_if.true:
	call void @error()
	ret i32 0
main.17_if.false:
