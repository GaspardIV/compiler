...
main_entry:
	...
	%tmp..1 = getelementptr [1 x i8], [1 x i8]* @.str.str0, i32 0, i32 0
...
main.2_while.body:
	...
	br i1 %tmp..20, label %main.4_if.true, label %main.5_if.end
main.1_while.cond:
	%i = phi i32 [0, %main_entry], [%tmp..24, %main.2_while.body]
	%s1 = phi i8* [%tmp., %main_entry], [%tmp..12, %main.2_while.body]
