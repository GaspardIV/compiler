...
define void @Point3.constructor(%Point3* %this) {
	%z = getelementptr %Point3, %Point3* %this, i32 0, i32 0
	store i32 0, i32* %z
...
Point3.move_entry:
	...
	%tmp..4 = getelementptr %Point3, %Point3* %self, i32 0, i32 2
...
define void @Point4.constructor(%Point4* %this) {
	%w = getelementptr %Point4, %Point4* %this, i32 0, i32 0
	store i32 0, i32* %w
	%z = getelementptr %Point4, %Point4* %this, i32 0, i32 1
	store i32 0, i32* %z
	%x = getelementptr %Point4, %Point4* %this, i32 0, i32 2
	store i32 0, i32* %x
	%y = getelementptr %Point4, %Point4* %this, i32 0, i32 3
	store i32 0, i32* %y
	ret void
}
...
Point4.move_entry:
	...
	%tmp..3 = add i32 %tmp..2, %dx
	store i32 %tmp..3, i32* %tmp.
	%tmp..4 = getelementptr %Point4, %Point4* %self, i32 0, i32 3
	%tmp..6 = load i32, i32* %tmp..4
	%tmp..7 = add i32 %tmp..6, %dy
	store i32 %tmp..7, i32* %tmp..4
	ret void
