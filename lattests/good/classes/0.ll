...
define void @Foo.constructor(%Foo* %this) {
	...
	%label = getelementptr %Foo, %Foo* %this, i32 0, i32 2
...
main2_entry:
	...
	%tmp..3 = getelementptr %Foo, %Foo* %tmp..1, i32 0, i32 2
	store i32 2, i32* %tmp..3
	%tmp..5 = getelementptr %Foo, %Foo* %tmp..1, i32 0, i32 1
...
main_entry:
	%tmp. = call %Foo* @main2()
	%tmp..1 = getelementptr %Foo, %Foo* %tmp., i32 0, i32 2
	%tmp..2 = load i32, i32* %tmp..1
	call void @printInt(i32 %tmp..2)
	%tmp..4 = getelementptr %Foo, %Foo* %tmp., i32 0, i32 1
	%tmp..5 = load %Foo*, %Foo** %tmp..4
	%tmp..6 = getelementptr %Foo, %Foo* %tmp..5, i32 0, i32 2
