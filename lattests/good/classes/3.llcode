...
define void @Node.constructor(%Node* %this) {
	%visited = getelementptr %Node, %Node* %this, i32 0, i32 0
	store i1 false, i1* %visited
	%value = getelementptr %Node, %Node* %this, i32 0, i32 1
	store i32 0, i32* %value
	%neighbours = getelementptr %Node, %Node* %this, i32 0, i32 2
...
Node.init_entry:
	...
	%tmp..2 = getelementptr %Node, %Node* %self, i32 0, i32 1
	store i32 %val, i32* %tmp..2
	%tmp..3 = getelementptr %Node, %Node* %self, i32 0, i32 2
...
Node.addNeighbour_entry:
	%tmp..4 = getelementptr %Node, %Node* %self, i32 0, i32 2
...
define void @List.constructor(%List* %this) {
	%head = getelementptr %List, %List* %this, i32 0, i32 0
	%headtmp = bitcast i32* null to %Node*
	store %Node* %headtmp, %Node** %head
	%tail = getelementptr %List, %List* %this, i32 0, i32 1
...
List.getHead_entry:
	%tmp. = getelementptr %List, %List* %self, i32 0, i32 0
...
List.makeSingleton_entry:
	...
	%tmp..1 = getelementptr %List, %List* %self, i32 0, i32 1
...
define void @Queue.constructor(%Queue* %this) {
	%first = getelementptr %Queue, %Queue* %this, i32 0, i32 0
	%firsttmp = bitcast i32* null to %List*
	store %List* %firsttmp, %List** %first
	%last = getelementptr %Queue, %Queue* %this, i32 0, i32 1
...
Queue.get_entry:
	%tmp..4 = getelementptr %Queue, %Queue* %self, i32 0, i32 0
	%tmp..5 = load %List*, %List** %tmp..4
	%tmp..6 = bitcast i32* null to %List*
	%tmp..7 = icmp eq %List* %tmp..5, %tmp..6
...
Queue.get.3_if.end:
	...
	%tmp..11 = getelementptr %List, %List* %tmp..10, i32 0, i32 0
	%tmp..12 = load %Node*, %Node** %tmp..11
	%tmp..15 = load %List*, %List** %tmp..4
	%tmp..16 = getelementptr %List, %List* %tmp..15, i32 0, i32 1
...
Queue.get.4_if.true:
	%tmp..26 = getelementptr %Queue, %Queue* %self, i32 0, i32 1
...
Queue.isEmpty_entry:
	%tmp. = getelementptr %Queue, %Queue* %self, i32 0, i32 0
	%tmp..1 = load %List*, %List** %tmp.
	%tmp..2 = bitcast i32* null to %List*
...
Queue.put_entry:
	...
	%tmp..8 = getelementptr %Queue, %Queue* %self, i32 0, i32 0
...
Queue.put.2_if.false:
	%tmp..14 = getelementptr %Queue, %Queue* %self, i32 0, i32 1
